...
def match_font(ttf: ttFont.TTFont) -> Union[tuple[dict[str, str], str], tuple[dict[str, str], list[str]]]:
    """输入晋江文学城字体对应的 ttf 对象，输出匹配后结果"""
    std_coord_table = load_std_font_coord_table()
    ...
    FUZZ = 20
    for jj_std_item in std_coord_table:
